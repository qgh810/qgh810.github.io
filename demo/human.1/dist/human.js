(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("Human", [], factory);
	else if(typeof exports === 'object')
		exports["Human"] = factory();
	else
		root["Human"] = factory();
})(this, function() {
...
exports.default = function (str) {
  var output = document.getElementsByClassName(CLASS_NAME)[0];
  output.innerHTML += str;
  output.innerHTML += '<br>';
};

// 容器类名
var CLASS_NAME = 'output-container';
// 输出函数
...
var _write = __webpack_require__(34);
...
// 定义通用睡眠方法
var _sleep = function _sleep(time) {
  return new _promise2.default(function (resolve, reject) {
...
var _Human = function () {
  function _Human(name) {
    (0, _classCallCheck3.default)(this, _Human);
  ...
  (0, _createClass3.default)(_Human, [{
    key: 'init',
    value: function init() {
      this.steps = [];
    ...
    value: function hi() {
      ...
      this.steps.push(function () {
        (0, _write2.default)('\u4F60\u597D\uFF0C' + _this.name + '\uFF01');
      });
      return this;
    }
    //  执行行为队列
    ...
    value: function play() {
      ...
      this.tid = setTimeout((0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
        var i;
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this.firstSleepTime && (0, _write2.default)('\u5F00\u59CB\u7B49\u5F85' + this.firstSleepTime + '\u79D2..');
                i = 0;
    ...
    key: 'sleepFirst',
    value: function sleepFirst(s) {
      if (!s) return this;
      this.firstSleepTime += Number(s);
      this.steps.unshift(function () {
        return _sleep(Number(s) * 1000);
      });
      this.play();
      return this;
    }
    ...
    value: function eat(food) {
      ...
      if (!food) return this;
      this.steps.push(function () {
        (0, _write2.default)(_this2.name + '\u5403\u4E86' + food);
      });
      this.play();
      return this;
    }
...
module.exports = !__webpack_require__(4) && !__webpack_require__(25)(function(){
