...
export default {
  ...
  user_message: {
    ...
    no_users: 'without choose the user', // 未选择用户
    hasnot_users: 'without choose the user' // 未选择用户
  },
  ...
  title: {
    ...
    history: 'Data analysis', // 历史记录
    chart: 'Chart Analysis', // 图表分析
    data_analysis: 'Data analysis', // 数据分析
    date: 'Date', // 日期
    add_plan: 'add plan', // 添加计划
    edit_plan: 'edit plan', // 编辑计划
    setting_unit: 'unit setting' // 单位设置
  },
  ...
  messages: {
    setting_success: 'set successfully', // 设置成功
    save_success: 'save successed', // 保存成功
    add_success: 'Added successfully', // 添加成功
    over_weight: 'overweight', // 重量超重
    low_power: 'low voltage', // 电池电量低
    user_name_length: 'The user name must be 1～16 characters', // 用户名必须是1～16个字符
    open_Bluetooth: 'Turn on the bluetooth and allow“YiLai Scale” to be connected with the device ', // 打开蓝牙来允许“YiLai Scales”连接到配件
    range_target_weight: 'It still need…to get to your target weight.', // 距离您的目标体重还需
    plan_name_length: 'Name must be 1～16 characters', // 名称必须是1～16个字符
    target_weight: 'Target weight number must be greater than zero ', // 目标体重必须是大于0的数字
    end_date: 'Ending date should later than start date', // 结束日期必须大于开始日期
    add_plan: 'You have no plan presently, add one now!', // 您还没有计划,赶紧新增一个计划吧！
    del_plan: 'Are you sure to delete plan?', // 确定要删除这个计划吗？
    del_user: 'Are you sure to delete?', // 确定要删除
    del_device: 'Are you sure to delete the device?' // 确定要删除该设备吗？
  },
  ...
  more_weight_messages: {
    ...
    internalage: 'body age', // 体内年龄
    organs: 'body fat', // 内脏脂肪
  ...
  device: {
    ...
    rename: 'rename', // 重命名
    unbind: 'Unbound', // 解绑
    unbind_device: 'Unbound Device', // 解绑设备
    no_devices: 'without the device', // 暂无设备
    rename_modal: {
      title: 'rename' // 重命名
    }
  },
